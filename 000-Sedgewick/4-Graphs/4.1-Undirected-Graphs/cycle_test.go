...
func TestHasCycle(t *testing.T) {
	...
	t.Run("tree with additional edge creating cycle", func(t *testing.T) {
		...
		assert.True(t, result, "Adding edge to tree should create cycle")
	})
	...
	t.Run("complex graph with cycle", func(t *testing.T) {
		...
		assert.True(t, result, "Complex graph with embedded cycle should be detected")
	})
	...
	t.Run("complete graph K4", func(t *testing.T) {
		...
		assert.True(t, result, "Complete graph should contain cycles")
	})
