...
func TestShortestPathToVertexDirected(t *testing.T) {
	t.Run("path to self", func(t *testing.T) {
		g := graphs.NewDigraph(3)
		g.AddEdge(0, 1)

		path := ShortestPathToVertexDirected(g, 0, 0)
	...
	t.Run("direct connection", func(t *testing.T) {
		...
		path := ShortestPathToVertexDirected(g, 0, 1)
	...
	t.Run("shortest path vs longer path", func(t *testing.T) {
		...
		path := ShortestPathToVertexDirected(g, 0, 4)
	...
	t.Run("no path exists - disconnected", func(t *testing.T) {
		...
		path := ShortestPathToVertexDirected(g, 0, 2)
	...
	t.Run("star graph - leaf to leaf", func(t *testing.T) {
		...
		path := ShortestPathToVertexDirected(g, 1, 3)
	...
	t.Run("complete graph", func(t *testing.T) {
		...
		path := ShortestPathToVertexDirected(g, 0, 3)
	...
	t.Run("invalid source vertex - negative", func(t *testing.T) {
		...
		path := ShortestPathToVertexDirected(g, -1, 1)
	...
	t.Run("invalid source vertex - out of bounds", func(t *testing.T) {
		...
		path := ShortestPathToVertexDirected(g, 5, 1)
	...
	t.Run("invalid target vertex - out of bounds", func(t *testing.T) {
		...
		path := ShortestPathToVertexDirected(g, 0, 5)
	...
	t.Run("large graph performance", func(t *testing.T) {
		...
		path := ShortestPathToVertexDirected(g, 0, size-1)
